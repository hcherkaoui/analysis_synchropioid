...
if __name__ == '__main__':
    ...
    # python3 plot_silhouette_score_per_params_single.py --plots-dir plots --results-dir ../03_hrf_est/results_hrf_estimation_subject/ --verbose 1
    ...
    fig, axs = plt.subplots(nrows=2, ncols=1, sharex=True, figsize=(5, 2))

    axs[0].plot(lbdas, silhouette_score, color='tab:orange')
    ...
    axs[1].errorbar(lbdas, mean_a_hat, yerr=std_a_hat, color='tab:blue')
